...
<!-- ########## START: LEFT PANEL ########## -->
<div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>K D A F</a></div>
<div class="sl-sideleft">
    ...
    <div class="sl-sideleft-menu">
        <a href="<?php echo base_url('admin'); ?>" class="sl-menu-link active">
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="<?php echo base_url('customer/add');?>" class="nav-link">Add Customer</a></li>
            <li class="nav-item"><a href="<?php echo base_url('customer');?>" class="nav-link">Show Customers</a></li>
        </ul>
            ...
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    <span class="logged-name">
                        <?php echo "Hi " . $this->session->userdata('fname'); ?>

                        <span class="hidden-md-down">
                            <?php echo $this->session->userdata('lname'); ?>
                        </span>
                    </span>
                    <img src="<?php echo base_url(); ?>/assets/img/zazi.jpg" class="wd-32 rounded-circle" alt="profile photo">
                </a>
...
<!--                        <li><a href=""><i class="icon ion-ios-folder-outline"></i> Collections</a></li>-->
                        <li><a href="<?php echo base_url('admin/logout'); ?>"><i class="icon ion-power"></i> Sign
                                Out</a></li>
                    </ul>
                </div><!-- dropdown-menu -->
            </div><!-- dropdown -->
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
            <div class="media-list">
                ...
                <a href="" class="media-list-link">
                    <div class="media">
                        <img src="<?php echo base_url(); ?>/assets/img/img3.jpg" class="wd-40 rounded-circle" alt="">
                ...
                <a href="" class="media-list-link">
                    <div class="media">
                        <img src="<?php echo base_url(); ?>/assets/img/img4.jpg" class="wd-40 rounded-circle" alt="">
                        <div class="media-body">
                ...
                <a href="" class="media-list-link">
                    <div class="media">
                        <img src="<?php echo base_url(); ?>/assets/img/img7.jpg" class="wd-40 rounded-circle" alt="">
                        <div class="media-body">
                            <p class="mg-b-0 tx-medium tx-gray-800 tx-13">Robert Walker</p>
                            <span class="d-block tx-11 tx-gray-500">5 hours ago</span>
                            <p class="tx-13 mg-t-10 mg-b-0">I should be incapable of drawing a single stroke at the
                                present moment<?php echo base_url(); ?>/assets.</p>
                        </div>
                    </div><!-- media -->
                </a>
                <a href="" class="media-list-link">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="tx-13 mg-t-10 mg-b-0">When, while the lovely valley teems with vapour around me,
                                and the meridian sun strikes<?php echo base_url(); ?>/assets.</p>
                        </div>
                    </div><!-- media -->
                </a>
                <a href="" class="media-list-link">
