...
//        echo '<pre>'; print_r($this->session->all_userdata()); exit;
    ...
    {
        $data['show'] = $this->order_model->show_list_informaton();
    ...
    public function ajax_save()
    {
        ...
        $this->order_model->insert_user($data);
    ...
    {
        $this->order_model->delete_user($id);
        redirect('users');
    }/* Delete User Ends*/
    ...
    {
        $data['result'] = $this->order_model->get_data_by_id($id);
        $data['id'] = $id;
    ...
    {   /* user data array to send in database */
        ...
        $this->order_model->update_user($data,$id);
        $result['type'] = "success";
        $result{'data'} = $data;
